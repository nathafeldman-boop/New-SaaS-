      ...
      <main className="bg-cream">
        <div className="container-page pt-28 sm:pt-32">
          ...
          <nav className="text-sm text-cocoa-500" aria-label="Fil d'Ariane">
            ...
            <a href="/coupes" className="hover:text-ink">Coupes</a>
            <span className="px-1.5">/</span>
          ...
          <div className="mt-8 grid items-start gap-10 lg:grid-cols-2">
            <div>
              <span className="eyebrow">Coupe homme</span>
              ...
              <dl className="mt-8 grid grid-cols-2 gap-3 text-sm">
                {cut.vibe && <Fact label="Style" value={cut.vibe} />}
                {cut.maintenance && <Fact label="Entretien" value={cut.maintenance} />}
                {shapes.length > 0 && (
                  <Fact label="Morphologies" value={shapes.join(", ")} />
                )}
                {typeof cut.popularity === "number" && (
                  <Fact label="Popularité" value={`${cut.popularity}/100`} />
                )}
              </dl>

              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href="/scan" className="btn-primary">Essayer cette coupe sur ma photo</a>
                <a href="/coupes" className="btn-ghost">Voir toutes les coupes</a>
              </div>
            </div>
          ...
          {related.length > 0 && (
            <section className="border-t border-clay-200 py-14">
              <h2 className="display-2 text-2xl text-ink">Autres coupes à découvrir</h2>
