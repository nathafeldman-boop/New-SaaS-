        ...
        <div className="relative mx-auto max-w-2xl">
          <Reveal>
            <h2 className="display-2 text-balance text-4xl text-cream sm:text-6xl">
              {en
                ? "Your hair can change. Discover your score."
          ...
          <Reveal delay={0.08}>
            <p className="mx-auto mt-6 max-w-lg text-lg text-clay-200">
              {en ? (
                <>
                  One photo is all it takes: get your diagnosis and your score out of 100{" "}
                  <strong className="font-semibold text-cream">for free</strong>. Then let{" "}
                  {siteConfig.name} guide you, day after day, for 30 days.
                </>
              ) : (
                <>
